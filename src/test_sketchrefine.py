import SketchRefine as sr
import pandas as pd
import pulp as pl
import time

og = pd.read_csv('data/tpch.csv')
...
# Q1 = sr.SketchRefine(df, representatives, 'max', A_0='count_order', count_constraint=(1, None), c1=('sum_base_price',
#               None, 15469853.7043), c2=('sum_disc_price', None, 45279795.0584), c3=('sum_charge', None, 95250227.7918),
#               c4=('avg_qty', None, 50.353948653), c5=('avg_price', None, 68677.5852459),
#               c6=('avg_disc', None, 0.110243522496))
...
Q2 = sr.SketchRefine(df, representatives, 'min', A_0='ps_min_supplycost', count_constraint=(1, None),
                     c1=('p_size', None, 8))
...
# Q3 = sr.SketchRefine(df, representatives, 'min', count_constraint=(1, None), c1=('revenue', 413930.849506, None))
...
# Q4 = sr.SketchRefine(df, representatives, 'min', count_constraint=(1, None), c1=('o_totalprice', None, 453998.242103),
