...
def get_min_representative_for_group(input_dataframe, partitioning_attributes):
...
def get_max_representative_for_group(input_dataframe, partitioning_attributes):
